    ...
    <footer className="w-full border-t bg-gradient-to-b from-muted/30 to-muted/50 md:pb-0 pb-20">
                <div className="max-w-6xl mx-auto py-12 px-4 sm:px-6">
                  ...
                  <div className="flex flex-col md:flex-row justify-between items-center pt-8 border-t border-gray-300 text-sm text-muted-foreground">
                    ...
                    <p className="text-center md:text-left mb-2 mt-2 md:mb-0">© {new Date().getFullYear()} White Waters. All rights reserved.<a href="https://v19.tech/?utm_source=white_waters&utm_medium=referral&utm_campaign=built_by_v19" target="_blank" rel="noopener noreferrer" className="ml-1 text-inherit opacity-80 underline-offset-2 hover:underline">· Built by V19</a></p>
