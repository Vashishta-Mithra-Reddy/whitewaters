...
export default function Navigation() {
    ...
    return (
        <div className="hidden md:flex gap-4">
              ...
              {/* <Link href={"/home"} className={`text-foreground px-5 py-2 rounded-lg hover:text-foreground hover:bg-foreground/10 ${pathname==="/home"?"bg-foreground/10 border-2 border-dashed border-foreground/10":""}`}>
                Home
              </Link> */}
